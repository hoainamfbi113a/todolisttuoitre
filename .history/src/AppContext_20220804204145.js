...
function AppProvider({ children }) {
  ...
  const data = [
    tasks, setTasks,isLoading, setIsLoading,isUpdating, setIsUpdating,form,taskIndex, setTaskIndex,taskInput, setTaskInput,level, setLevel,isEditing, setIsEditing,editingTask, setEditingTask,editingTaskLevel, setEditingTaskLevel,isSearching, setIsSearching,searchTasks, setSearchTasks
  ]
